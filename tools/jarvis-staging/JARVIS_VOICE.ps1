# JARVIS_VOICE.ps1 - Voice-Enabled Interactive Mode
...
function Execute-VoiceCommand {
    ...
    switch ($Intent.command) {
        "help" {
            ...
            Write-Host ""
            Write-Host "JARVIS COMMANDS:" -ForegroundColor Cyan
            ...
            Write-Host "  exit       - Exit JARVIS"
            Write-Host ""
        }

        "status" {
            $output = "JARVIS is ready and waiting for commands"
            Write-Host ""
...
function Start-VoiceInterface {
    ...
    Write-Host "║     JARVIS LOCAL - VOICE MODE             ║" -ForegroundColor Cyan
    ...
    Speak-Text "JARVIS is ready. Speak or type your command."
